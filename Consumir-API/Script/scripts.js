...
const dailyFeelsLike = document.querySelector("#dailyFeelsLike");
const dailyTempMax = document.querySelector("#dailyTempMax");
const dailyTempMin = document.querySelector("#dailyTempMin");
...
const showWeatherData = async (city) =>{
    ...
    dtElement.innerText = `${data.daily.dt}`;
